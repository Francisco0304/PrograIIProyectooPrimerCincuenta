...
class PassengerTest {
	    ...
	    void setup(){
	        vehiclePassenger = new Passenger("JIA764","Renault 4",(short)1977,"Verde Militar",(byte)5);
	    }
	    ...
	    void getNumPassengers() {
	        setup();
	        assertEquals(5,vehiclePassenger.getNumPassenger());
	        vehiclePassenger.setNumPassenger((byte)(vehiclePassenger.getNumPassenger() - 2));
	        assertEquals(3,vehiclePassenger.getNumPassenger());
	    }
	    ...
	    void addDriver() {
	        ...
	        assertEquals(1, vehiclePassenger.getDrivers().size());
	    }
	    ...
	    void getDrivers(){
	        ...
	        assertEquals(2, vehiclePassenger.getDrivers().size());
	        //Validar que el arreglo que se retorna sea una copia para que no permita su modificación fuera de la clase
	        vehiclePassenger.getDrivers().add( new Driver("72647","Reynaldo",LocalDate.of(1961,Month.JULY,20)));
	        assertEquals(2, vehiclePassenger.getDrivers().size());
	    }
